...
Mutation data that fail annotation by Genome-Nexus are excluded from the release. For example, this occurs when the allele extracted from the VCF or MAF file does not match the reference allele, or when the VEP tool is unable to annotate the data.
...
+---------------------------+-----------------------------+----------------------+-----------------------+
| data_clinical_sample.txt  | data_mutations_extended.txt	| SAMPLE_ID            |  Tumor_Sample_Barcode |
+---------------------------+-----------------------------+----------------------+-----------------------+
