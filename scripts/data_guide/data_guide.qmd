...
coverage_per_panel = get_list_assay_info_table(allowed_coverage,
                                               pipelinedf,
                                               "coverage")
kable(coverage_per_panel, caption = 'Coverage per Panel/Pipeline')
```
...
kable(alterations_per_panel, caption = 'Alteration Types per Panel/Pipeline')
```
...
kable(specimen_per_panel, caption = 'Preservation Techniques per Panels/Pipelines')
```
...
kable(gene_number_info[order(gene_number_info$SEQ_ASSAY_ID), ],
      caption = 'Sequence Assay Genomic Information',
      row.names = F, col.names = c("Sequencing Assay", "Calling Strategy", "Number of genes", "Target Capture Kit"))
```
