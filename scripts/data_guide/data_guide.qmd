...
Description on most of the data files can be found in the [cBioPortal file formats](https://docs.cbioportal.org/file-formats/0) docs.
...
* Description: The structural variant file contains information on structural variants.
* Details: [Structural Variant format](https://docs.cbioportal.org/file-formats/#structural-variant-data)

genomic_information.txt

* Description: File describing genomic coordinates covered by all platforms for GENIE data. This file is used for MAF in BED filter and to generate gene panel files
